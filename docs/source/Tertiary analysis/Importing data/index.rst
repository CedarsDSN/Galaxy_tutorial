...
.. note::
  ...
  3. For the rest of the steps, follow from step 3- step 11 of the above steps for those who haven't run the Primary analysis workflow and want to run the example datasaet.
